...
if st.button("Analyze my Selected Building"):
        ...
        st.write("2.b. During 2020, how do certain characteristics of my building perform as compared to the worst performing buildings in Seattle?")

        #filters to choose for the user
        df99 = [df.columns[6],df.columns[11],df.columns[14],df.columns[13],df.columns[29]]
        filtered = st.selectbox("Select a characteristic", options=list(df99))
